...
def create_media_kml(root_path, media_path, photo_list, video_list, time_list, dwell_time, tz):
...
<img src="$FILENAME$"/><font size = 18><br><br></font>]]>"""
    ...
    video_html_block = r"""<![CDATA[<font size = "18">$NAME$</font><OBJECT ID="MediaPlayer" width="720" height="576" CLASSID="CLSID:22D6F312-B0F6-11D0-94AB-0080C74C7E95" CODEBASE="http://activex.microsoft.com/activex/controls/mplayer/en/nsmp2inf.cab#Version=5,1,52,701" STANDBY="Loading Windows Media Player components..." TYPE="application/x-oleobject">
<param name="fileName" value="$FILENAME$">
<param name="autoStart" value="False">
<param name="showControls" value="True">
<param name="ShowStatusBar" value="True">
<param name="ShowDisplay" VALUE="True">
<embed type="application/x-mplayer2" src="$FILENAME$" name="MediaPlayer" width="720" height="576" ShowControls="1" ShowStatusBar="1" ShowDisplay="1" autostart="0"> </embed>
</object>
    ...
    if len(time_list) == 0:
        ...
        for i in range(0, len(time_list)):
            ...
            if i == 0:
                ...
                # Add the html block into the description, changing the $NAME$ tag and $FILENAME$ Tag
                # Currently defaulting to using the local time as the name of the time lapse video, or at least what to put in
                # that field
            ...
            for j in range(0, i):
                ...
                if time_list[i].get_group_number() == time_list[j].get_group_number():
                    ...
                    filename = media_path + "\\" + time_list[i].get_filename()
                    filename = "file:///" + filename.replace("\\", "/").replace(" ", "%20").lower()
                    time_items[i - k].description = video_html_block.replace('$NAME$', name).replace('$FILENAME$', filename)
